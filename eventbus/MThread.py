...
class MThread(object):
    ...
    async def _thread_event_handle(self, event_client):
        while True:
            ...
            if self.exit_flag:
                event_client.client_close()
                # print('_thread_event_handle exit....', self._child_class.thread_name)
                return
    ...
    async def _thread_run(self, child_thread):
        while True:
            ...
            if self.exit_flag:
                # print('_thread_run exit....', self._child_class.thread_name)
                return
    ...
    def exit(self):
        # print('............thread begin exit:', self._child_class.thread_name)
        self.exit_flag = True
        self.thread.join(timeout=2)
        # print('............thread is exit:', self._child_class.thread_name)
